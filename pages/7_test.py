...
def prompt_generator(query, docs):
    prompt = f"""
    1. 사용자가 욕, 성적인 표현을 사용하면 해당 표현에 관하여는 답변할 수 없다고 응답하세요.
    2. 사용자의 질의에 진로설계, 꿈, 특기와 관련없는 내용이 포함된 경우 해당내용과 관련있는 질의만 답변할 수 있다고 응답하세요.
    3. 검색된 자료에는 다음과 같은 내용이 있습니다. : 학과이름, 학과소개, 학과주요교과목, 학과관련 고등학교 선택과목, 학과관련 추천 도서
    4. 사용자의 질의와 관련된 내용을 검색된 자료를 참고하여 관련 학과에 대해 설명하세요.
